...
import { Box, Typography, Button, TextField, Checkbox, FormControlLabel, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
  ...
  return (
    <div>
      <Box sx={{ p: "30px" }}>
        ...
        >
          <Typography variant="h4" sx={{fontWeight:'600'}}>Faturalar</Typography>
        ...
        <Box sx={{
          ...
          >
            <Typography variant="h6" sx={{fontWeight:'550'}}>Fatura ara</Typography>
            <Box
              sx={{
                display: 'flex',
                alignItems: 'center',
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-evenly', gap: '30px' }}>
                ...
                <FormControl fullWidth>
                  <InputLabel id="invoice-status-label">Fatura Durumu</InputLabel>
                  <Select
                ...
                <FormControl fullWidth>
                  <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <DatePicker
                      ...
                      renderInput={(params) => (
                        <TextField {...params} fullWidth sx={{ bgcolor: "white", borderRadius: 1 }} />
                      )}
                    />
            ...
            <Table sx={{ minWidth: 700 }} aria-label="customized table">
              <TableHead>
                <TableRow>
                  ...
                  <StyledTableCell align="right">Birim Fiyat (₺/m³)</StyledTableCell>
                  <StyledTableCell align="right">Toplam Tutar (₺)</StyledTableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {rows.map((row) => (
                  <StyledTableRow key={row.id}>
                    ...
                    <StyledTableCell align="right">{row.consumption}</StyledTableCell>
