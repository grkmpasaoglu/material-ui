...
const Nav3 = () => {
    ...
    return (
        ...
        >
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: '16px', flexGrow: 1, justifyContent: { xs: 'space-between', md: 'flex-end' } }}>
                {/* Hamburger Menü */}
                <IconButton
                ...
                <Box sx={{ display: { xs: 'none', md: 'flex' }, alignItems: 'center', gap: '16px' }}>
                    ...
                    <Divider orientation="vertical" flexItem sx={{ bgcolor: '#979FA8', height: '50px' }} />
                    <Box sx={{ width: '50px', height: '50px', overflow: 'hidden', borderRadius: '50%', bgcolor: '#F7F6FC' }}>
                        <img
