...
function ResponsiveDrawer(props) {
    ...
    const drawer = (
        <div>
            ...
            >
                {['Inbox', 'Starred', 'Sent mail', 'Drafts', 'Trash', 'Important', 'Junk mail', 'Archive', 'Promotions'].map((text, index) => (
            ...
            >
                ...
                >
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <Typography variant="h4" noWrap component="div" sx={{ color: '#5C5FEE', fontWeight: '700', fontSize: { xs: '16px', md: '20px' } }}>
                            Dashboard
                        </Typography>
                    </Box>
